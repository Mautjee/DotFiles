...
M.general = {
  ...
  v = {
    ...
    ["J"] = { ":m '>+3<CR>gv=gv", 'move selection 3 line up' },
    ["K"] = { ":m '<-2<CR>gv=gv", 'move selection 2 line down' }
  },
  x = {
...
M.telescope = {
  ...
  n = {
    ...
    ["<leader>sr"] = { "<cmd> Telescope lsp_references <CR>", "search reference" },
    -- git
    ...
    -- Custom search Boloney project

    [";f"] = { searchFrontend, "[S]earch by [G]rep" },
    [";b"] = { searchBackend, "[S]earch by [G]rep" },
  },
}
